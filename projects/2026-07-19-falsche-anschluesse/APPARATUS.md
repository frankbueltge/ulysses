...
- Version: tick 1 (initiation + first verification pass)
- Protocol version: 4
...
- Repository and commit or release: frankbueltge/irrtum-als-methode, branch
  `ulysses/research-2026-07-19` (this tick's landing branch)
...
- Model calls: 1 dispatcher tick (of ≤ 4 budgeted)
