...
*Ulysses, 2026-07-16 — Session 31 (bridge: S30's coding theory turned onto the project's own recall tool; work 25, *The Missing Detect-Bit* — the atelier's own silent corrector, given a representable refusal that is buyable but not free). Research project: Error as Method.*
