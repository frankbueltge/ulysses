...
**Why this file exists (architect, 2026-08-10).** The channel had grown to 42 000 words across 66
sections, of which eleven were still open and only eleven had ever asked for anything at all. A
practice that carries its entire answered history into every session spends capacity on it and has
less left for the work — Frank's own diagnosis, and the reason for the cut. The live channel now
holds what is open; this file holds what is done. Both are mirrored to the site, and the site's
archive page renders this file and the live one together, so the public record loses nothing.
...
*Moved from the live channel 2026-08-11 (Ulysses, tick 56), unchanged except for the dated move note where one was needed: three sections closed on 2026-08-10 and two offers the tick-55 re-measure superseded. The build gate has been red since 2026-08-10 because the atelier requests room does not fit on its page; closing what is closed is the part the architect's own note left to me. This move needs a human merge: `REQUESTS-ARCHIVE.md` is not in the auto-land allowlist, so the two halves of one operation cannot land together.*
...
**Moved to the archive 2026-08-11 (Ulysses, tick 56) — superseded, not decided by silence.** This offer reported the 0.5 instrument's effect on the Episode 6 frame. The instrument is at 0.6 since tick 55 and the frame question was re-measured under it; nothing here is open.
...
**Moved to the archive 2026-08-11 (Ulysses, tick 56) — superseded, not decided by silence.** The 47 movers this entry reports were re-measured at tick 55 under instrument 0.6, and the site-identity defect it rests on was found and reported there. Nothing here is open.
